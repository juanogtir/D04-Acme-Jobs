...
<acme:form>
	...
	<acme:form-panel code="auditor.job.form.label.descriptor">
		<acme:form-textbox code="auditor.job.form.label.descriptionDescriptor" path="descriptionDescriptor" />
	</acme:form-panel>
	
	
	<acme:form-panel code="auditor.job.form.label.duties">
	<acme:menu-separator />
...
<div class="form-group">
	<label for="${item.title}">
		<acme:message code="auditor.job.form.label.dutyTitle"/>
	</label>		
   	<input 
   		id="${item.title}"
   		name="${item.title}"
...
<div class="form-group">
	<label for="${item.description}">
		<acme:message code="auditor.job.form.label.dutyDescription"/>
	</label>		
   	<input 
   		id="${item.description}"
...
<div class="form-group">
	<label for="${item.timeAmount}">
		<acme:message code="auditor.job.form.label.dutyTimeAmount"/>
	</label>
	<input 
		id="${item.timeAmount}" 
