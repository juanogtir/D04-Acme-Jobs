...
<acme:form>
	<acme:form-textbox code="authenticated.job.form.label.referenceNumber" path="referenceNumber" placeholder="EEEE-JJJJ"/>
...
<div class="form-group">
	<label for="${item.title}">
		<acme:message code="authenticated.job.form.label.dutyTitle"/>
	</label>		
   	<input 
   		id="${item.title}"
   		name="${item.title}"
...
<div class="form-group">
	<label for="${item.description}">
		<acme:message code="authenticated.job.form.label.dutyDescription"/>
	</label>		
   	<input 
   		id="${item.description}"
...
<div class="form-group">
	<label for="${item.timeAmount}">
		<acme:message code="authenticated.job.form.label.dutyTimeAmount"/>
	</label>
	<input 
		id="${item.timeAmount}" 
